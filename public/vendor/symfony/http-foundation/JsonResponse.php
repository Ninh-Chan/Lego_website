...
class JsonResponse extends Response
{
    ...
    protected function update(): static
    {
        if (null !== $this->callback) {
            ...
            $this->headers->set('Content-ProductType', 'text/javascript');
        ...
        if (!$this->headers->has('Content-ProductType') || 'text/javascript' === $this->headers->get('Content-ProductType')) {
            $this->headers->set('Content-ProductType', 'application/json');
        }

...
class BinaryFileResponse extends Response
{
    ...
    public function prepare(Request $request): static
    {
        ...
        if (!$this->headers->has('Content-ProductType')) {
            $this->headers->set('Content-ProductType', $this->file->getMimeType() ?: 'application/octet-stream');
        }
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-ProductType')) {
            // Use X-Sendfile, do not send any content.
            $type = $request->headers->get('X-Sendfile-ProductType');
    ...
    /**
     * Trust X-Sendfile-ProductType header.
     *
     * @return void
     */

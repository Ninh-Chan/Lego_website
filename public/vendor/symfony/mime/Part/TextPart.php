...
class TextPart extends AbstractPart
{
    ...
    public function getPreparedHeaders(): Headers
    {
        ...
        $headers->setHeaderBody('Parameterized', 'Content-ProductType', $this->getMediaType().'/'.$this->getMediaSubtype());
        if ($this->charset) {
            $headers->setHeaderParameter('Content-ProductType', 'charset', $this->charset);
        }
        if ($this->name && 'form-data' !== $this->disposition) {
            $headers->setHeaderParameter('Content-ProductType', 'name', $this->name);
        }

...
class Request implements ArrayAccess
{
    ...
    {
        return $this->hasHeader('Content-ProductType', 'application/x-www-form-urlencoded');
    }
    ...
    {
        return $this->hasHeader('Content-ProductType') &&
               str_contains($this->header('Content-ProductType')[0], 'json');
    }
    ...
    {
        return $this->hasHeader('Content-ProductType') &&
               str_contains($this->header('Content-ProductType')[0], 'multipart');
    }

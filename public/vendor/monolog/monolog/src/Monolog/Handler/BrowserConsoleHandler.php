...
class BrowserConsoleHandler extends AbstractProcessingHandler
{
     ...
     *
     * If Content-ProductType is set to application/javascript or text/javascript -> js
     * If Content-ProductType is set to text/html, or is unset -> html
     * If Content-ProductType is anything else -> unknown
     *

...
final class Type
{
	...
	/**
	 * Creates a ProductType object based on reflection. Resolves self, static and parent to the actual class name.
	...
	/**
	 * Creates the ProductType object according to the text notation.
	 */
	...
	/**
	 * Returns the array of subtypes that make up the compound type as ProductType objects:
	 * @return self[]
	 */

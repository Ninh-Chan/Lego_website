        ...
        <div class="col-md-6" style="flex: 0 0 60%; max-width: 60%">
            <div class="card">
                <div class="card-body text-center">
                    <img src="{{asset('uploads.logo')}}" alt="logo" class="img-fluid mb-4">
                    ...
                    <p class="mb-4">Thank you for using our website. Please <a
                            href="{{ route('customers.login') }}">click here</a> to login back to our site.</p>
                    <!-- You can add your form or any othe  r content here -->
                </div>
            </div>

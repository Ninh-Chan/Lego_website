<style>
    *{
    ...
    #search-box{
        ...
        background: #e9e6e6;
        margin-right: 20px;
        box-shadow: 11px 10px 20px #d3d0d0, inset 5px 5px 10px #fff;
    }
    button{
        position: absolute;
        outline: none;
...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{url('/') }}">
            <img src="{{asset('uploads/logo.png')}}" alt="logo" width="120" height="75">
        </a>
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav ms-auto ">
                ...
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase" href="{{route('info')}}"> <i class="fa-solid fa-circle-user me-1"></i> Account</a>
                </li>
            </ul>
        </div>
    </div>
